...
import { useAppProviderContext } from '@/components/app-lication/src/useAppContext'

export const defaultNamespace = 'plc'
...
export const useBem = (block: string) => {
  const namespace = toRef(useAppProviderContext().prefixCls)
...
export type UseBem = ReturnType<typeof useBem>
